  ...
  <div class="cred-container">
    ...
    >
      <template #searchItem>
        ...
        <div class="search-item">
          <span>状态</span>
          <el-select v-model="listQuery.auditStatus" clearable placeholder="请选择状态">
      ...
      <template #operBtn>
        ...
        <el-button type="warning" icon="el-icon-edit-outline" :disabled="qyDisabled" @click="toAudit(1)">审核通过</el-button>
        <el-button type="danger" icon="el-icon-edit-outline" :disabled="jyDisabled" @click="toAudit(2)">失效</el-button>
...
export default {
  ...
  mounted () {
    ...
    // this.$set(this.listQuery, 'status', 0)
