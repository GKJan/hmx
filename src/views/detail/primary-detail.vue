      ...
      <div class="swipe-item">
        ...
        <div class="result">
          <div class="left-part">
            <div class="top">
              ...
              <div class="items">
                <div class="item-left">
                  ...
                  <span>肺活量：{{ info.feiHl }}ml</span>
                  <span>跳绳：{{ info.tiaos }}次</span>
            ...
            <div class="bottom">
              <span>移动：{{ info.remove }}</span>
              <span>接球：{{ info.pass }}</span>
              <span>投篮：{{ info.shoot }}</span>
            </div>
          </div>
  ...
  created () {
    this.api.getXxDetail({ id: this.$route.query.id }).then(res => {
      ...
      this.compareData = [
        ...
        {
          my: res.data.feiHl, avg: res.data.feiHlAvg
        },
        {
          my: res.data.tiaos, avg: res.data.tiaosAvg
        },
        {
